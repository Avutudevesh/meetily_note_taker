...
- Artifacts prefixed with `cortex-test-`
...
```
cortex-{workflow}-{platform}-{target}-{version}
```

**Examples:**
- `cortex-devtest-macOS-aarch64-apple-darwin-0.1.3`
- `cortex-test-windows-x86_64-pc-windows-msvc-0.1.3`
- `cortex-macos-aarch64-release-0.1.3`
