...
When **reviewing recordings** in Cortex, we recommend using **computer speakers** or **wired headphones** rather than Bluetooth headphones for accurate playback.
...
1. **Cortex records at 48kHz** (professional audio standard)
...
- ❌ **Reviewing Cortex recordings** - Use wired/speakers instead
...
### This is Not a Cortex Bug

The issue is in **macOS's Bluetooth audio stack**, not in Cortex's recording engine.
...
**A**: This is a macOS/Bluetooth limitation, not a Cortex bug. We've correctly recorded at 48kHz.
...
**A**: Yes! Cortex now shows a warning when Bluetooth headphones are active during playback.
...
**Applies To**: Cortex v0.0.5+ on macOS
