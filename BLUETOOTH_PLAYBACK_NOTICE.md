...
When **reviewing recordings** in Suno, we recommend using **computer speakers** or **wired headphones** rather than Bluetooth headphones for accurate playback.
...
1. **Suno records at 48kHz** (professional audio standard)
...
- ❌ **Reviewing Suno recordings** - Use wired/speakers instead
...
### This is Not a Suno Bug

The issue is in **macOS's Bluetooth audio stack**, not in Suno's recording engine.
...
**A**: This is a macOS/Bluetooth limitation, not a Suno bug. We've correctly recorded at 48kHz.
...
**A**: Yes! Suno now shows a warning when Bluetooth headphones are active during playback.
...
**Applies To**: Suno v0.0.5+ on macOS
