...
if (-not $env:TAURI_SIGNING_PRIVATE_KEY) {
    ...
    Write-Host "     Get-Content .tauri\cortex.key -Raw" -ForegroundColor Gray
    Write-Host ""
    ...
    Write-Host "     `$env:TAURI_SIGNING_PRIVATE_KEY = Get-Content .tauri\cortex.key -Raw" -ForegroundColor Gray
