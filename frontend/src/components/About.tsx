...
export function About() {
    ...
    const handleContactClick = async () => {
        try {
            await invoke('open_external_url', { url: 'https://suno.zackriya.com/#about' });
        } catch (error) {
    ...
    return (
        <div className="p-4 space-y-4 h-[80vh] overflow-y-auto">
            ...
            <div className="text-center">
                ...
                {/* <h1 className="text-xl font-bold text-gray-900">Suno</h1> */}
            ...
            <div className="space-y-3">
                <h2 className="text-base font-semibold text-gray-800">What makes Suno different</h2>
