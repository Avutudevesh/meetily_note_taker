@echo off
REM Cortex Build Script for Windows
...
echo 🚀 Building Cortex application...
...
echo.
echo DESCRIPTION:
echo   This script builds the Cortex Tauri application for Windows.
