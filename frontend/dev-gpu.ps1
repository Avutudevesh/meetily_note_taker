# GPU-accelerated development script for Cortex (Windows PowerShell)
# Automatically detects and runs in development mode with optimal GPU features

Write-Host "GPU-Accelerated Development Mode for Cortex" -ForegroundColor Blue
Write-Host ""
...
Write-Host ""
Write-Host "Starting Cortex in development mode..." -ForegroundColor Blue
Write-Host ""
